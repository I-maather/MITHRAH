...
# **لا تُكرَّر هنا خطوةٌ لا يعرف هذا السكربت أنها لازمة.** كان يُطبع في كل
# نشرٍ نداءٌ إلى `tailscale up` وإن كانت الشبكة موصولة منذ أيام. والخادم وحده
# يعرف حالته، وقد قالها في مخرَجه أعلاه.
green "تمّ."
echo
echo "  حالة الشبكة الخاصة مذكورة في آخر مخرَج الخادم أعلاه."
echo "  فإن قال «لا خطوة متبقّية» فلا شيء عليكِ هنا."
