...
def test_a_dollar_of_risk_under_the_hard_cap_is_not_refused_for_missing_the_target():
    ...
    **الفحص الذي يقلب استنتاجاً سابقاً — وسببُ القلب مقيس.**
    ...
    ويبقى الرقم الثاني صحيحاً بمسافةٍ أخرى. والحدودُ النافذةُ على
    مرجع ٣٠٠ بعد دستور 0.6.0 هي: الهدف ٥٫٠٠ والسقفُ الصلب ١٠٫٠٠
    بقرار المالكة ١٩ سبتمبر ٢٠٢٦. فوقفُ ١٠٠٠ نقطة على الكمية
    الدنيا يكلّف نحو ١٠٫٠٢$ — **فوق السقف بسنتين**، ورفضُه صحيح.
    ووقفُ ٧٥٠ نقطة يكلّف نحو ٧٫٥١$: فوق الهدف ودون السقف، وهو
    المدى الذي وُجد هذا الاختبار ليحرسه. فأُعيد اشتقاق المسافة

    وقرارُ المالكة كما هو: الهدف تفضيلٌ لا سقفُ رفض. فتُقبل الصفقة، ويُقال
    في سببها أنها تجاوزت الهدف.
    """
    pipeline, state, _ = build(
        symbol="EURUSD", entry="1.16000", stop="1.08500", target="1.29000",
