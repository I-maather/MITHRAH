...
#: تواتر **محاولة** تحديث التقويم — والغرضُ التعافي لا الطزاجة.
#:
#: كانت ساعةً، وكانت الساعةُ تعني أنّ `429` واحدةً في لحظة الإقلاع تُعطّل
#: بوابةَ الأخبار ستّين دقيقة. وقد وقع ذلك مقيساً في ١٩ سبتمبر ٢٠٢٦.
#:
#: وهذا تواترُ **محاولة** لا نداءٍ شبكيّ: المزوّد يخنقُ نفسه —
#: `MIN_REFRESH_INTERVAL` بعد النجاح و`MIN_RETRY_AFTER_FAILURE` بعد
#: الإخفاق. فالنجاحُ يُكلّف ثلاثةَ نداءاتٍ في الساعة على أكثر تقدير،
#: والانقطاعُ العابر يُصلَح في خمس دقائق بدل ستّين.
