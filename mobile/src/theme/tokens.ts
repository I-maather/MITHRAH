...
export const palette = {
   ...
   */
  jamr: {
    // **الصبغة معتمدة ولا تُمَسّ — والإضاءة تُخفَض للنصّ وحده.**
    //
    // `#B85A26` على تعبئته الفاتحة يبلغ 3.96:1، ونصُّ الشارة ليس نصّاً
    // كبيراً فيلزمه 4.5. وخفضُ الإضاءة ٨٪ يبلغ 4.54 ويُبقي الزاوية عند
    // ‎21.5°‎ والإشباع عند 0.66 — أي أنّ اللون هو هو، أعتمَ بقدرٍ يُقرأ.
    lightText: '#A95323',
    light: '#B85A26',
    lightSoft: '#F7EBE1',
    dark: '#D97B3C',
