...
export interface CandlesData {
  /**
   * آخرُ سعرٍ رآه القرار لكل أداة — **وليس بثّاً مباشراً**.
   *
   * يأتي من النداء الذي تجلبه دورةُ القرار أصلاً، فعمرُه دورةٌ واحدة على
   * الأكثر. و`at_utc` يقول متى قُرئ، فلا تُقرأ الشاشةُ «الآن» وهي «قبل
   * دقيقة». وغيابُه يعني أن الدورة لم تصل إلى الأداة بعد، لا أن السعر صفر.
   */
  live?: Record<string, { price: string; at_utc: string | null }>;
