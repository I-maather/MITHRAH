...
export const READ_ROUTES = [
  ...
  'audit/recent',
  'scan/latest',
  // **مسار اليوم بأرقامه.** كان محسوباً في الخادم منذ بُني ولا يصل إلى
  // أيّ شاشة: وحدةٌ سليمةٌ غيرُ موصولة. وهو الجواب على «لماذا لم تتداول
  // اليوم؟» — والسؤالُ الذي لم يجبه أيٌّ من ثمانية عشر تطبيقاً في البحث.
  'participation/today',
